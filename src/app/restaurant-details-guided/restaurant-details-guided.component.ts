  ...
  tours: GuidedTour[] = [
      ...
      steps: [
        {
          ...
          content: 'Amazon SageMaker analysed the sentiment of your review!',
          orientation: Orientation.Bottom,
          useHighlightPadding: true,
        },
        {
...

    {
      ...
      steps: [
        ...
        {
          selector: '.first-review .restaurant-review-details-header',
          content: 'The overall sentiment remains positive.',
          orientation: Orientation.Bottom,
          useHighlightPadding: true,
        },
        {
          selector: '.first-review .restaurant-review-scores',
          content: 'However, the category scores this time have variations.',
          orientation: Orientation.Bottom,
          useHighlightPadding: true,
          closeAction: () => this.startNextTour(),
        },
